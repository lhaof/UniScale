...
class AuxScaleClipMask2FormerHead(MaskFormerHead):
    ...
    def __init__(self,
        ...
        if self.scale_query_cross:
            self.query_scale_decoder = Mask2FormerTransformerDecoder(num_layers=1, layer_cfg=transformer_decoder.layer_cfg, return_intermediate=False)
