...
def nuclei_metric_compute_multi_core(matched_annotations_list, gt_folder, pred_folder, categories):
...
def nuclei_metric_compute_single_core(proc_id, annotation_set, gt_folder, pred_folder, ignore_index):
    nuclei_stat = NucleiState()
